...
function LoginPage() {  
    ...
    <Navbar></Navbar>
            ...
            <div className='w-3/4 h-fit border-2 rounded-lg px-20 border-gray-200 m-auto'>  
                ...
                <div className='w-4/6 grid grid-rows-2'>
                ...
                <h3 className='mb-2'>First Name</h3>
                    ...
                    <div className='flex w-full gap-4 mb-20'>
                        ...
                        <button className='border w-1/3 h-16 border-gray-300 bg-black rounded-md px-4 pt-3 pb-1'> <h3 className='text-white'> Copy Email </h3> </button>
                        <button className='border w-1/3 h-16 border-gray-300 bg-black rounded-md px-4 pt-3 pb-1'> <h3 className='text-white'> Next </h3> </button>
                    </div>
                </div>
